...
public class WalHistoryTests {
    ...
    @Autowired
    private ExchangeWalletWalExtMapper extMapper;

    @Autowired
    private ExchangeWalletWalRecordService recordService;

    private List<ExchangeWalletWalRecord> list;

    @Test
    public void testCreateTable() throws SQLException {
        String sql = "CREATE TABLE `exchange_wallet_wal_record_his_%s` (\n" +
                ...
                "  PRIMARY KEY (`id`),\n" +
                "  KEY `index_exchange_wallet_wal_record_smc` (`sync_id`,`member_id`,`coin_unit`)\n" +
    ...
    public void testTableExists() throws SQLException {
        String table = "exchange_wallet_sync_record_his_201909261";
    ...
    public void testSaveBatch() {
        extMapper.saveBatch("exchange_wallet_wal_record_his_20190926", this.list);
    }
