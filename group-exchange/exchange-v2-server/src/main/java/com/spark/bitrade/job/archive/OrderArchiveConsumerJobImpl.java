...
public class OrderArchiveConsumerJobImpl extends AbstractArchiveJob<String> implements ArchiveJobDef {
    ...
    private ExchangeWalletWalRecordService walletWalRecordService;
    ...
    protected void handle(String orderId) {
        ...
        // 迁移订单记录
        exchangeOrderService.transfer(orderId);
    ...
    @Autowired
    public void setWalletWalRecordService(ExchangeWalletWalRecordService walletWalRecordService) {
