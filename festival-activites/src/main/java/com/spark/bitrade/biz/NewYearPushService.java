...
@Service
@Slf4j
public class NewYearPushService {
    ...
    @Async
    public void sendStationMessage(String content, String title, Long memberId){
        Map<String, Object> silkPlatInfo = newYearMineralService.findSilkPlatInfo();
        if (silkPlatInfo!=null){
            Object useInstation = Optional.ofNullable(silkPlatInfo.get("useInstation")).orElse(1);
            Object useOffline = Optional.ofNullable(silkPlatInfo.get("useOffline")).orElse(1);
        if (useInstation.equals(1)||useOffline.equals(1)){
            ...
            noticeEntity.setIsAlert(useOffline .equals(1)  ? 1 : 0);
            noticeEntity.setIsOffline(useInstation .equals(1) ? 1 : 0);
            ...
            sysNoticeEntity.getExtras();
            Map<String, Object> extras = sysNoticeEntity.getExtras();
            extras.put("id", id);
            extras.put("targetType", NoticeExtrasType.NEW_YEAR.getValue());
