...
MySQL - 5.6.34-log : Database - otc_sync
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`otc_sync` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=390 DEFAULT CHARSET=utf8 COMMENT='会员扩展表，与原member表一对一';
...
CREATE TABLE `member_benefits_order` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=591 DEFAULT CHARSET=utf8 COMMENT='会员申请订单';
...
CREATE TABLE `member_fee_day_stat` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='会员购买情况日统计';
...
CREATE TABLE `member_recommend_commision` (
  ...
  `commision_usdt_qty` decimal(24, 8) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1503 DEFAULT CHARSET=utf8 COMMENT='会员邀请佣金';
